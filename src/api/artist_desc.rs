...
mod tests {
    ...
    async fn test_api_artist_desc() -> Result<(), Box<dyn std::error::Error>> {
        let resp = artist_desc("30229793".into(), None, Some(Crypto::Api)).await?;
        println!("{}", resp);
    ...
    async fn test_linuxapi_artist_desc() -> Result<(), Box<dyn std::error::Error>> {
        let resp = artist_desc("30229793".into(), None, Some(Crypto::Linuxapi)).await?;
        println!("{}", resp);
    ...
    async fn test_weapi_artist_desc() -> Result<(), Box<dyn std::error::Error>> {
        let resp = artist_desc("30229793".into(), None, Some(Crypto::Weapi)).await?;
        println!("{}", resp);
    ...
    async fn test_eapi_artist_desc() -> Result<(), Box<dyn std::error::Error>> {
        let resp = artist_desc("30229793".into(), None, Some(Crypto::Eapi)).await?;
        println!("{}", resp);
