...
mod tests {
    ...
    async fn test_api_album() -> Result<(), Box<dyn std::error::Error>> {
        let resp = album("81099298".into(), None, Some(Crypto::Api)).await?;
        println!("{}", resp);
    ...
    async fn test_linuxapi_album() -> Result<(), Box<dyn std::error::Error>> {
        let resp = album("81099298".into(), None, Some(Crypto::Linuxapi)).await?;
        println!("{}", resp);
    ...
    async fn test_weapi_album() -> Result<(), Box<dyn std::error::Error>> {
        let resp = album("81099298".into(), None, Some(Crypto::Weapi)).await?;
        println!("{}", resp);
    ...
    async fn test_eapi_album() -> Result<(), Box<dyn std::error::Error>> {
        let resp = album("81099298".into(), None, Some(Crypto::Eapi)).await?;
        println!("{}", resp);
